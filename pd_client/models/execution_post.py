...
class ExecutionPost(object):
    ...
    def process_instance(self):
        """
        Gets the process_instance of this ExecutionPost.
        Unique ID of the process instance this execution is of

        :return: The process_instance of this ExecutionPost.
        :rtype: int
        """
    ...
    def process_instance(self, process_instance):
        """
        Sets the process_instance of this ExecutionPost.
        Unique ID of the process instance this execution is of

        :param process_instance: The process_instance of this ExecutionPost.
        :type: int
        """
